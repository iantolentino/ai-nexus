...
- `tools/brain-doctor.ps1`, `tools/context-metrics.ps1`, `tools/select-context.ps1`, `tools/context-diff.ps1`, `tools/handoff-baseline.ps1`, `tools/session-checkpoint.ps1`
